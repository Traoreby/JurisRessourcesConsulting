...
import { mockServices } from "@/lib/admin/mock-data";
                  ...
                  <tr key={service.id} className="hover:bg-slate-50/50 transition-colors">
                    <td className="p-4">
                      <div className="flex flex-col gap-0.5">
                        <button onClick={showNotice} className="text-slate-300 hover:text-primary transition-colors" aria-label="Monter">
                          <ArrowUp size={14} />
                        </button>
                        <span className="text-xs text-slate-400 text-center">{service.ordre}</span>
                        <button onClick={showNotice} className="text-slate-300 hover:text-primary transition-colors" aria-label="Descendre">
                          <ArrowDown size={14} />
                        </button>
                      </div>
                    </td>
